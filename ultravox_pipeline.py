...
class UltravoxPipeline(transformers.Pipeline):
    ...
    def save_pretrained(self, save_directory, **kwargs):
        """
        Save the pipeline's model, tokenizer, and processor configs.
        """
        import json
        import os
        
        # Call parent method to save model and tokenizer
        super().save_pretrained(save_directory, **kwargs)
        
        # Selectively save only the processor config files (not the full processor)
