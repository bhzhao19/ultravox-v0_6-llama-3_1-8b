        ...
        **kwargs,
        ...
        if text_model_id is not None:
            ...
            if hasattr(text_config, "text_config"):
                logging.info(
                    f"{text_model_id} is likely a multimodal model as its config has a text_config attribute. We will use the text_config attribute for the text model config."
                )
                logging.info(f"original text_config: {text_config}")
